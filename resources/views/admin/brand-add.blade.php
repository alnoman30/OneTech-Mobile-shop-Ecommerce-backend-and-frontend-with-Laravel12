                                    ...
                                    <div class="form-vertical__item bg-style">
                                        <form enctype="multipart/form-data" method="POST" action="{{ route('admin.brand.store')}}">
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <input type="text" id="category_name" name="name"  value="{{ old('name')}}" placeholder="Brand name">
                                            </div>
                                            <div class="input__group mb-25">
                                                <label>Brand Slug</label>
                                                <input type="text" id="category_slug" name="slug"  value="{{ old('slug')}}" placeholder="Brand slug">
                                            </div>
                                            <div class="input__group mb-25">
